...
# Custom password reset form; mainly just to change the link to reset the password within the email sent to the registered user.
class CustomAllAuthPasswordResetForm(DefaultPasswordResetForm):
    ...
    def save(self, request, **kwargs):
        ...
        for user in self.users:
            ...
            url = f"{settings.FRONTEND_URL}/password/reset/confirm/{user_pk_to_url_str(user)}/{temp_key}/?user={user}"
